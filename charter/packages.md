...
Static reference. The living strategic-tree artefact lives at [charter/roadmap.md](roadmap.md) per D44; this file is retained for direct package-list reference and is updated at phase boundaries. RICE scores and version log live in `roadmap.md`.
