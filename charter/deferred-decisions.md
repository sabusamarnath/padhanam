...
**Activation trigger.** Sequencing decision (immediate S40b, P12 audit close, or a Phase 1 hygiene window) deferred. Activation no later than the Phase 1 close audit at P12 close, which assesses procurement-grade-readiness across the full Phase 1 surface.
