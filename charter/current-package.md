...
## P8 active — S26a closed; S26b next
...
**S26b next.** McKinsey 7-Step methodology and its seven role aggregates land in the platform-managed methodology surface per `briefs/p8/mckinsey-7-step.md`. Authored against the role-first model from S26a; control-plane only.
