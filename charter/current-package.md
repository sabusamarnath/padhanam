...
- S6: Ollama and LiteLLM in Compose. Default model (Qwen 2.5 7B per D15) pulled. LiteLLM Langfuse callback configured. TLS configuration read through zephyr/config/. Image pinned to digest, scanned. End-to-end smoke: a curl to the gateway returns a completion and the trace appears in Langfuse.
