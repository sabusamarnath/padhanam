...
- `Vadkkan` directory housekeeping: rename to `Zephyr`, verify compose project naming auto-corrects on next `make up`, fold into the first P3 session.