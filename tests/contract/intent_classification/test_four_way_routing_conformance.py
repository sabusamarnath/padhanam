"""Four-way meta-classifier routing conformance (D140, P15, S55b-2).

Binds the four-way routing single-source-of-truth structurally: the four
...
def test_meta_classifier_schema_enum_is_the_four_real_cells() -> None:
    """The schema's cell_identifier enum is exactly the four real cells.
...
def test_dispatch_lexicon_covers_all_four_real_cells() -> None:
...
def test_cell_identifier_real_cells_plus_sentinel() -> None:
    """CellIdentifier carries the four real cells plus the sentinel only."""
