"""Zephyr FastAPI application factory.
...
_log = logging.getLogger("zephyr.api")
...
def _configure_tracing(service_name: str = "zephyr-api") -> None:
...
def create_app(
    *,
    ...
    async def lifespan(_: FastAPI) -> AsyncIterator[None]:
        _log.info("zephyr-api starting up")
        yield
        _log.info("zephyr-api shutting down")
