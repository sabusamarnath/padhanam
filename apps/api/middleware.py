...
zephyr.security.auth (S5). The production swap is profile selection
...
from zephyr.observability import (
    SecurityEvent,
    SecurityEventCategory,
    SecurityEventLogger,
    file_security_event_logger,
)
from zephyr.security import AuthError, Principal, verify_credential
