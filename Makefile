...
# uncontrolled externals (llm_drafted/pending), replacing the generic
# llm_drafted drafts and preserving any user_authored element (invariant 4).
...
# create the :Opportunity Flow items, attach units by company signature, set each
